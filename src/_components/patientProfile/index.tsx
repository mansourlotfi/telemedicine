          ...
          <div className="col-lg-8 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
            <div className="card border-0 shadow overflow-hidden">
              ...
              <div className="tab-content p-4" id="pills-tabContent">
                ...
                >
                  <h5 className="mb-0">راهنما:</h5>

                  <p className="text-muted mt-4 mb-0">
                    از این قسمت (پروفایل) میتوانید نوبتهای رزور شده خود را م
                    شاهده نم ایید. و در صورتی که قصد رزور نوبت دارید ، قبل از
                    اقدام ، از قسمت پرونده پزشکی (در همین صفحه) اطلاعات اولیه ،
                    بیماری و یا سوال خود و مدارک پزشکی مرتبط در صورت وجود
                    (سونوگرافی ، آزمایش و ...) را تکمیل کنید. و بعد از مراحل فوق
                    از آیکون "دریافت نوبت" در تاریخ و زمان دلخواه خود رزور نوبت
                    را انجام دهید.
                  </p>
