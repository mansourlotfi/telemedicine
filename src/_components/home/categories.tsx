...
function Categories() {
 ...
 const  modalHandler = (title:string,value:string)=>{
  ...
  backgroundImage: "url(" + "../assets/images/category/nabarvari.jpg" + ")",
  ...
  height:200
              ...
              <div className="card-body p-0 mt-3">
                ...
                شایعترین بیماری قابل درمان عامل ناباروری  ...                </p>
                <Link to="#" className="link"  onClick={()=>modalHandler("ناباروری در آقایان",slugs.nabarvari)}>
          ...
          <div className="col-xl col-md-4 col-12 mt-4 pt-2">
            <div className="card features feature-primary border-0 p-4 rounded-md shadow">
             ...
             <div  className="col-lg-3 col-md-3 col-6" style={{  
  backgroundImage: "url(" + "../assets/images/category/tomor.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'contain',
  backgroundRepeat: 'no-repeat',
  width:"100%",
  height:200
              ...
              <div className="card-body p-0 mt-3">
                ...
                <p className="text-muted mt-3">
                با پیشرفتهایی که امروزه در درمان سرطان رخ داده  ...                </p>
                <Link to="#" className="link"  onClick={()=>modalHandler("تومورها و سرطان",slugs.tomor)}>
                  پیدا کنید <i className="ri-arrow-left-line align-middle"></i>
                </Link>
              </div>
            </div>
          ...
          <div className="col-xl col-md-4 col-12 mt-4 pt-2">
            ...
            <div  className="col-lg-3 col-md-3 col-6" style={{  
  backgroundImage: "url(" + "../assets/images/category/sang.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'contain',
  backgroundRepeat: 'no-repeat',
  width:"100%",
  height:200
              ...
              <div className="card-body p-0 mt-3">
                ...
                <p className="text-muted mt-3">
                برای تشکیل سنگ های ادراری عوامل متعددی ...                </p>
                <Link to="#" className="link"  onClick={()=>modalHandler("سنگ ادراری",slugs.sang)}>
                  پیدا کنید <i className="ri-arrow-left-line align-middle"></i>
                </Link>
              </div>
            </div>
          ...
          <div className="col-xl col-md-4 col-12 mt-4 pt-2">
            ...
            <div  className="col-lg-3 col-md-3 col-6" style={{  
  backgroundImage: "url(" + "../assets/images/category/prostat.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'contain',
  backgroundRepeat: 'no-repeat',
  width:"100%",
  height:200
              ...
              <div className="card-body p-0 mt-3">
                ...
                <p className="text-muted mt-3">
                بعد از 40 سالگی به دلایل مختلفی در مردان شاهد ...                </p>
                <Link to="#" className="link"  onClick={()=>modalHandler("پروستات",slugs.prostat)}>
                  پیدا کنید <i className="ri-arrow-left-line align-middle"></i>
                </Link>
              </div>
            </div>
          ...
          <div className="col-xl col-md-4 col-12 mt-4 pt-2">
            <div className="card features feature-primary border-0 p-4 rounded-md shadow">
            <div  className="col-lg-3 col-md-3 col-6" style={{  
  backgroundImage: "url(" + "../assets/images/category/moshkelat.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'contain',
  backgroundRepeat: 'no-repeat',
  width:"100%",
  height:200
              ...
              <div className="card-body p-0 mt-3">
                ...
                <p className="text-muted mt-3">
                اختلالات ادراری میتواند شامل تکرر ‌ادرار ...                </p>
                <Link to="#" className="link"  onClick={()=>modalHandler("مشکلات ادراری",slugs.moshkelat)}>
                  پیدا کنید <i className="ri-arrow-left-line align-middle"></i>
                </Link>
              </div>
            </div>
          ...
          <div className="col-xl col-md-4 col-12 mt-4 pt-2">
            <div className="card features feature-primary border-0 p-4 rounded-md shadow">
            <div  className="col-lg-3 col-md-3 col-6" style={{  
  backgroundImage: "url(" + "../assets/images/category/ofoonat.jpg" + ")",
  backgroundPosition: 'center',
  backgroundSize: 'contain',
  backgroundRepeat: 'no-repeat',
  width:"100%",
  height:200
              ...
              <div className="card-body p-0 mt-3">
                ...
                <p className="text-muted mt-3">
                عفونت‌های ادراری (UTI) از شایع‌ترین عفونت‌ها  ...                </p>
                <Link to="#" className="link" onClick={()=>modalHandler("عفونت های ادراری",slugs.ofoonat)}>
                  پیدا کنید <i className="ri-arrow-left-line align-middle"></i>
                </Link>
              </div>
            </div>
      ...
      <CategoryModal open={open} type={text} title={title} handleClose={()=>setOpen(false)} />
    </section>
  );
}
